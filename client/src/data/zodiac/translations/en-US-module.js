...
import { translations as enUSTranslations1to4 } from './en-US-signs-1-4.js';
import { translations as enUSTranslations5to8 } from './en-US-signs-5-8.js';
import { translations as enUSTranslations9to12 } from './en-US-signs-9-12.js';

const translations = {
  ...enUSTranslations1to4,
  ...enUSTranslations5to8,
  ...enUSTranslations9to12
};
