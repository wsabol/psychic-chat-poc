...
import { translations as deDeTranslations1to4 } from './de-DE-signs-1-4.js';
import { translations as deDeTranslations5to8 } from './de-DE-signs-5-8.js';
import { translations as deDeTranslations9to12 } from './de-DE-signs-9-12.js';

const translations = {
  ...deDeTranslations1to4,
  ...deDeTranslations5to8,
  ...deDeTranslations9to12
};
