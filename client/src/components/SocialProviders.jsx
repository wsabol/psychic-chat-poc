...
export function SocialProviders({ 
  ...
  // Note: Apple Sign-In is disabled on login/register but available in ReAuth modal
  const providers = [
    {
      id: 'facebook',
      name: 'Facebook',
    ...
    // Apple Sign-In temporarily disabled - will be enabled after Apple Developer account setup
    // Uncomment the block below to enable Apple Sign-In on login/register:
    // {
    //   id: 'apple',
    //   name: 'Apple',
    //   icon: (
