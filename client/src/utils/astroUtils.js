 ...
 * DEPRECATED: Use loadZodiacSignsForLanguage() from ../data/zodiac/index.js instead
 * This function is kept for backward compatibility but returns null
 * @param {string} zodiacSignKey - Zodiac sign key (lowercase, e.g., 'aries')
 * @returns {null} - Always returns null; use dynamic loading for actual data
 */
export function getAstrologyData(zodiacSignKey) {
  // Deprecated: zodiac data is now loaded dynamically per language
  // Use loadZodiacSignsForLanguage() from ../data/zodiac/index.js instead
  return null;
}

/**
 * Get astrology data for a given birth date
 * DEPRECATED: Use loadZodiacSignsForLanguage() instead
 * @param {string} dateString - Birth date in YYYY-MM-DD format
 * @returns {null} - Returns null; use dynamic loading instead
 */
