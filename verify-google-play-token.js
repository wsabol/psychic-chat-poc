  ...
  try {
    ...
    try {
      ...
      console.log('⚠️   Both API versions returned 401 Unauthorized.');
        console.log('');
        console.log('   The service account has valid credentials but Play Console has NOT');
        console.log('   granted it permission to access this developer account\'s data.');
        console.log('');
        console.log('   ── HOW TO FIX ─────────────────────────────────────────────────');
        console.log('   1. Sign into Play Console as starshiptechnology1@gmail.com');
        console.log('      URL: https://play.google.com/console/u/0/users-and-permissions');
        console.log('');
        console.log('   2. Click "Invite new users" (top-right)');
        console.log('      Email: play-billing-api@psychic-chat-poc.iam.gserviceaccount.com');
        console.log('');
        console.log('   3. Under "Account permissions" (NOT per-app), check BOTH:');
        console.log('        ✓ View financial data, orders, and cancellation survey responses');
        console.log('        ✓ Manage orders and subscriptions');
        console.log('');
        console.log('   4. Click "Invite user" then wait 15-60 min and re-run this script.');
        console.log('');
        console.log('   NOTE: If the account is already listed, click on it and verify');
        console.log('   the two permissions above are checked at the ACCOUNT level (top');
        console.log('   section), NOT under "Add app" or a permission group. Remove any');
        console.log('   per-app rows if present.');
        console.log('   ────────────────────────────────────────────────────────────────');
        console.log('');
