    ...
    contactForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const apiUrl = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
                ...
                : 'https://c7wgh7tc7pihyrecotbkakgtla0jaavj.lambda-url.us-east-1.on.aws/';
            ...
            if (response.ok && result.success) {
                ...
                formMessage.textContent = result.message || 'Thank you! Your message has been sent. We\'ll get back to you within 24-48 hours.';
