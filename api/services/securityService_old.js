...
// ============================================
// 2FA and Session Settings (for SecurityPage)
// ============================================
...
export async function getVerificationMethods(userId, userEmail) {
  try {
    ...
    return {
      primaryEmail: userEmail,
      phoneNumber: sec.phone_number ? decrypt(sec.phone_number) : null,
      recoveryPhone: sec.recovery_phone ? decrypt(sec.recovery_phone) : null,
      recoveryEmail: sec.recovery_email ? decrypt(sec.recovery_email) : null,
