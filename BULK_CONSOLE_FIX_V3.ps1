# Bulk Console.error/warn Fixer - Version 3 (Direct file list)
...
Write-Host "BULK CONSOLE FIX V3 - Batch: $BatchName" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
foreach ($filePath in $Files) {
    ...
    try {
        ...
        if ($newContent -ne $originalContent) {
            ...
            Write-Host "    ⚠️  No changes" -ForegroundColor Yellow
            $skipCount++
        }
    }
    catch {
