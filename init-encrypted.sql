...
-- ===== messages table - with user_id_hash and encrypted content =====
...
-- ===== user_astrology table - with user_id_hash =====
...
-- ===== user_2fa_settings - with user_id_hash =====
...
-- ===== user_2fa_codes - with user_id_hash =====
...
-- ===== security - with user_id and encrypted fields =====
...
-- ===== user_violations - with user_id_hash =====
...
-- ===== user_consents - with user_id_hash =====
...
-- ===== user_sessions - with user_id_hash and encrypted fields =====
...
-- ===== user_astrology - for additional fields =====
CREATE TABLE IF NOT EXISTS user_astrology_enriched (
    id SERIAL PRIMARY KEY,
    user_id_hash VARCHAR(255) UNIQUE,
    astrology_data JSONB,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE INDEX IF NOT EXISTS idx_user_astrology_enriched_hash ON user_astrology_enriched(user_id_hash);
