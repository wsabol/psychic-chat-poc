...
export async function generateCosmicWeather(userId) {
    try {
        ...
        // Get current lunar phase and planetary positions
        ...
        try {
            ...
            console.warn('[COSMIC-WEATHER-HANDLER] Could not fetch current astro data:', err.message);
        }
        
        // Format current planetary data for Oracle
