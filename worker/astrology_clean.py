...
def calculate_current_planets():
    try:
        ...
        for planet_id, planet_name in planets:
            ...
            planet_data.append({"name": planet_name, "sign": sign, "degree": round(degree, 2), "retrograde": is_retrograde, "displayName": f"{planet_name} (R)" if is_retrograde else planet_name})
